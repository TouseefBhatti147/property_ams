...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('site_equipment_subcategories', function (Blueprint $table) {
            $table->increments('equipment_subcategory_id')->unique('equipment_subcategory_id_UNIQUE')->comment('ID');
    ...
    {
        Schema::dropIfExists('site_equipment_subcategories');
    }
};
