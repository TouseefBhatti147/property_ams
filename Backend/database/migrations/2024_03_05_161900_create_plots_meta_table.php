...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('plots_meta', function (Blueprint $table) {
            ...
            $table->decimal('curr_surcharge', 10, 0)->default(0);
            $table->decimal('prev_surcharge', 10, 0)->default(0);
        });
    }
    ...
    {
        Schema::dropIfExists('plots_meta');
    }
};
