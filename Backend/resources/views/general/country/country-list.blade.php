...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <div class="text-right">
                            <a href="{{ route('general.country.create-country') }}" class="btn btn-primary">Add New Country</a>
                        </div>        
    </div>
    <div class="card-body">
        ...
        <td><a href="{{ route('general.country.edit-country', ['id' => $country->id]) }}"><i class="fas fa-fw fa-wrench" aria-hidden="true"></i></a>
       | <form action="{{ route('general.country.destroy-country', ['country' => $country->id]) }}" method="POST" style="display: inline;">
